...
Assert-Match $files.Protocol 'ProtocolVersion\s*=\s*7;' 'protocol v7 mirror'
Assert-Match $files.Protocol 'DriverBuildId\s*=\s*2026072802;' 'startup protection driver build mirror'
