...
Assert-Match $files.Protocol 'ProtocolVersion\s*=\s*4;' 'protocol v4 mirror'
Assert-Match $files.Protocol 'DriverBuildId\s*=\s*2026071702;' 'startup protection driver build mirror'
