...
Assert-Match $files.Protocol 'ProtocolVersion\s*=\s*8;' 'protocol v8 mirror'
Assert-Match $files.Protocol 'DriverBuildId\s*=\s*2026072901;' 'startup protection driver build mirror'
