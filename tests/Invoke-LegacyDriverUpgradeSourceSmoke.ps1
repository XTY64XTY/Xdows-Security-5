...
Assert-Match $protocolPath 'LegacyUpgradeDriverBuildId\s*=\s*2026072801;' 'exact legacy upgrade driver build ID'
Assert-Match $protocolPath 'OlderLegacyUpgradeDriverBuildId\s*=\s*2026071802;' 'exact older legacy upgrade driver build ID'
Assert-Match $protocolPath 'OldestProtocolV6UpgradeDriverBuildId\s*=\s*2026071801;' 'exact oldest protocol v6 upgrade driver build ID'
...
Assert-Match $bridgePath 'LegacyUpgradeSources(?s:.*?)DriverProtocol\.LegacyUpgradeProtocolVersion(?s:.*?)DriverProtocol\.LegacyUpgradeDriverBuildId(?s:.*?)DriverProtocol\.OlderLegacyUpgradeDriverBuildId(?s:.*?)DriverProtocol\.OldestProtocolV6UpgradeDriverBuildId' 'exact v6 legacy sources'
...
Assert-NotMatch $bridgePath 'OldestProtocolV6UpgradeDriverBuildId\s*(?:<=|>=|<|>)' 'range-based oldest protocol v6 build acceptance'
