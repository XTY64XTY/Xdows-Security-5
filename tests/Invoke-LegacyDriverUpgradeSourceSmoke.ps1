...
Assert-Match $protocolPath 'LegacyUpgradeProtocolVersion\s*=\s*3;' 'exact legacy upgrade protocol version'
Assert-Match $protocolPath 'LegacyUpgradeDriverBuildId\s*=\s*2026071701;' 'exact legacy upgrade driver build ID'
