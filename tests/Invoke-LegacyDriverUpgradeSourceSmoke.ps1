...
Assert-Match $protocolPath 'LegacyUpgradeDriverBuildId\s*=\s*2026071802;' 'exact legacy upgrade driver build ID'
Assert-Match $protocolPath 'OlderLegacyUpgradeDriverBuildId\s*=\s*2026071801;' 'exact older legacy upgrade driver build ID'
...
Assert-Match $bridgePath 'LegacyUpgradeSources(?s:.*?)DriverProtocol\.LegacyUpgradeProtocolVersion(?s:.*?)DriverProtocol\.LegacyUpgradeDriverBuildId(?s:.*?)DriverProtocol\.OlderLegacyUpgradeDriverBuildId' 'exact v6 legacy sources'
