...
Assert-Match $files.Protocol 'ProtocolVersion\s*=\s*8' 'managed protocol v8'
Assert-Match $files.Protocol 'DriverBuildId\s*=\s*2026072901' 'managed driver build identity'
